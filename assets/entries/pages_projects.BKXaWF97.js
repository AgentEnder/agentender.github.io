...
import { a as require_react, n as require_jsx_runtime, r as onRenderClient, t as Loading_default } from "../chunks/chunk-BuRr5_Be.js";
import { n as IoClose, r as GenIcon, t as _Layout_exports$1 } from "../chunks/chunk-DVPl2RUB.js";
import { n as RelatedContent, t as ContentMarker } from "../chunks/chunk-DOTI3Cz8.js";
import { n as differenceInCalendarDays, r as toDate, t as format } from "../chunks/chunk-CEatORTM.js";
import { a as FaGlobe, i as FaGithub, n as FaCalendar, o as FaStar, s as useData, t as FaBook } from "../chunks/chunk-dwyb1mpo.js";
...
//#endregion
//#region pages/projects/styles.scss
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
//#endregion
//#region pages/projects/components/filter-search.tsx
var import_jsx_runtime = require_jsx_runtime();
function FilterSearch({ onSearch }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
		htmlFor: "repo-search-textbox",
		children: "Search"
...
//#endregion
//#region pages/projects/components/filter-checkbox.tsx
function FilterCheckbox({ label, onValueChange, allowIndeterminate, defaultValue }) {
	const [value, setValue] = (0, import_react.useState)(defaultValue);
	const input = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		if (value === null && allowIndeterminate && input.current) input.current.indeterminate = true;
	}, [
		value,
		input,
		allowIndeterminate
...
//#endregion
//#region pages/projects/components/filter-dropdown.tsx
function FilterDropdown({ label, onValueChange, options, defaultValue, multiple }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
		...
		id: label + "-dropdown",
		onChange: (e) => {
			if (multiple) onValueChange(Array.from(e.target.selectedOptions).map((o) => o.value));
		...
		children: options.map((option) => {
			if (typeof option === "string") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
				value: option,
				children: option
			}, option);
...
//#endregion
//#region pages/projects/components/filter-bar.module.scss
var filter_bar_module_default = { "filter-table": "_filter-table_1ahjp_2" };
//#endregion
//#region pages/projects/components/sort-functions.ts
function totalDownloads(p) {
	return Object.values(p.publishedPackages ?? {}).reduce((acc, { downloads }) => acc + downloads, 0);
}
function lastCommitTime(p) {
	const raw = p.lastCommit;
	if (!raw) return 0;
	const t = new Date(raw).getTime();
	return Number.isNaN(t) ? 0 : t;
}
var sortByRelevance = (projects) => {
	const relevance = /* @__PURE__ */ new Map();
	for (const p of projects) {
		const stars = p.stars ?? 0;
		const downloads = totalDownloads(p);
		const daysSinceCommit = p.lastCommit ? Math.max(differenceInDays(/* @__PURE__ */ new Date(), new Date(p.lastCommit)), 1) : Number.POSITIVE_INFINITY;
		relevance.set(p.repo, stars + downloads / 100 + 100 / daysSinceCommit);
	}
	return (a, b) => (relevance.get(b.repo) ?? 0) - (relevance.get(a.repo) ?? 0);
};
var sortByStars = () => (a, b) => (b.stars ?? 0) - (a.stars ?? 0);
var sortByDownloads = () => (a, b) => totalDownloads(b) - totalDownloads(a);
var sortByLastCommit = () => (a, b) => lastCommitTime(b) - lastCommitTime(a);
var SORT_OPTIONS = [
	{
		value: "relevance",
		label: "Relevance",
...
//#endregion
//#region pages/projects/components/filter-bar.tsx
function SearchFilter({ onSetFilter, filter: { initialValue, id } }) {
	const [state, setState] = (0, import_react.useState)(initialValue);
	(0, import_react.useEffect)(() => {
		if (state) onSetFilter(id, (p) => p.repo.toLowerCase().includes(state.toLowerCase()));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterSearch, { onSearch: (v) => {
		setState(v);
	} });
}
function LanguageFilter({ onSetFilter, context, filter }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterDropdown, {
		label: "Language",
		onValueChange: (v) => {
...
function LiveSiteFilter({ onSetFilter, filter: { id, initialValue } }) {
	const [state, setState] = (0, import_react.useState)(initialValue);
	(0, import_react.useEffect)(() => {
		if (state) onSetFilter(id, (p) => !!p.deployment);
		else onSetFilter(id, (p) => !p.deployment);
	}, [
		state,
		onSetFilter,
		id
	]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterCheckbox, {
		label: "Live site?",
		defaultValue: true,
		onValueChange: (v) => {
			setState(v);
...
function PublishedPackagesFilter({ onSetFilter, filter: { id, initialValue } }) {
	const [state, setState] = (0, import_react.useState)(initialValue);
	(0, import_react.useEffect)(() => {
		if (state) onSetFilter(id, (p) => Object.keys(p.publishedPackages ?? {}).length > 0);
		else onSetFilter(id, (p) => Object.keys(p.publishedPackages ?? {}).length === 0);
	}, [
		state,
		onSetFilter,
		id
...
var DEFAULT_FILTERS = [ALL_FILTERS[0]];
function FilterBar({ onSetFilter, onSetSort, repos, ...tableProps }) {
	const languages = (0, import_react.useMemo)(() => [...new Set(repos.flatMap((r) => Object.keys(r.languages ?? {})))], [repos]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("table", {
		...tableProps,
		className: filter_bar_module_default["filter-table"],
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
					htmlFor: "sort-by",
					children: "Sort by"
				}) }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
			...
			Array.from(filters.values()).map((filter) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				title: "Remove filter",
				onClick: () => {
			...
			availableFilters.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
				colSpan: 3,
...
//#endregion
//#region ../../node_modules/.pnpm/react-icons@5.5.0_react@19.1.1/node_modules/react-icons/di/index.mjs
...
//#endregion
//#region ../../libs/date-utils/src/lib/formatted-date.tsx
function FormattedDate({ date, format: format$1 }) {
	const [formattedDate, setFormattedDate] = (0, import_react.useState)();
	(0, import_react.useEffect)(() => {
		setFormattedDate(format(date, format$1));
	}, [date]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: formattedDate ?? date });
}
//#endregion
//#region ../../node_modules/.pnpm/react-icons@5.5.0_react@19.1.1/node_modules/react-icons/si/index.mjs
...
function SiMdx(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M.79 7.12h22.42c.436 0 .79.355.79.792v8.176c0 .436-.354.79-.79.79H.79a.79.79 0 0 1-.79-.79V7.912a.79.79 0 0 1 .79-.791V7.12Zm2.507 7.605v-3.122l1.89 1.89L7.12 11.56v3.122h1.055v-5.67l-2.99 2.99L2.24 9.056v5.67h1.055v-.001Zm8.44-1.845-1.474-1.473-.746.746 2.747 2.747 2.745-2.747-.746-.746-1.473 1.473v-4h-1.054v4Zm10.041.987-2.175-2.175 2.22-2.22-.746-.746-2.22 2.22-2.22-2.22-.747.746 2.22 2.22-2.176 2.177.746.746 2.177-2.177 2.176 2.175.745-.746Z" },
			"child": []
		}]
	})(props);
}
...
//#endregion
//#region ../../node_modules/.pnpm/react-icons@5.5.0_react@19.1.1/node_modules/react-icons/bs/index.mjs
function BsTerminalFill(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M0 3a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm9.5 5.5h-3a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1m-6.354-.354a.5.5 0 1 0 .708.708l2-2a.5.5 0 0 0 0-.708l-2-2a.5.5 0 1 0-.708.708L4.793 6.5z" },
			"child": []
		}]
	})(props);
}
//#endregion
//#region pages/projects/language-logos.tsx
function getLanguageLogo(language) {
	switch (language) {
		case "TypeScript": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiTypescript, { style: {
			color: "#007acc",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		} });
		case "JavaScript": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiJavascript, { style: {
			color: "#f0db4f",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		} });
		case "C#": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "24",
			height: "27",
			viewBox: "0 0 256 288",
			style: {
		...
		case "Python": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiPython, { style: {
			color: "#3776ab",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		} });
		case "C++": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiCplusplus, { style: {
			color: "#00599c",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		...
		case "SCSS":
		case "CSS": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiCss3, { style: {
			color: "#1572b6",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		} });
		case "HTML": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiHtml5, { style: {
			color: "#e34f26",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		} });
		case "MDX": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiMdx, { style: {
			color: "#f9ac00",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		} });
		case "Shell": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BsTerminalFill, { style: {
			color: "#000000",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
		} });
		case "Lua": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiLua, { style: {
			color: "#000080",
			fontSize: "1.5rem",
			verticalAlign: "middle",
			marginRight: "0.5rem"
...
//#endregion
//#region pages/projects/components/percent-bar.module.scss
var percent_bar_module_default = {
	"percent-bar-fill": "_percent-bar-fill_o5nz1_1",
	"percent-bar-label": "_percent-bar-label_o5nz1_9",
	"percent-bar": "_percent-bar_o5nz1_1"
};
//#endregion
//#region pages/projects/components/percent-bar.tsx
function PercentBar({ percent, label, color }) {
	const [hasBeenVisible, setHasBeenVisible] = (0, import_react.useState)(false);
	const el = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		if (!el.current || hasBeenVisible) return;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: percent_bar_module_default["percent-bar"],
		ref: el,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: percent_bar_module_default["percent-bar-fill"],
			style: {
				width: hasBeenVisible ? `${percent}%` : 0,
				...color ? { backgroundColor: color } : {}
			},
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: percent_bar_module_default["percent-bar-label"],
				children: percent + "%"
			})
		})
	});
...
var ProjectCard_module_default = {
	projectCard: "_projectCard_b7s07_1",
	sectionHeader: "_sectionHeader_b7s07_9",
	projectInfo: "_projectInfo_b7s07_18",
	infoRow: "_infoRow_b7s07_18",
	infoLabel: "_infoLabel_b7s07_35",
	infoValue: "_infoValue_b7s07_51",
	projectLanguages: "_projectLanguages_b7s07_70",
	languagesGrid: "_languagesGrid_b7s07_73",
	languageRow: "_languageRow_b7s07_82",
	languageName: "_languageName_b7s07_102",
	languageBar: "_languageBar_b7s07_115",
	projectPackages: "_projectPackages_b7s07_119",
	packagesGrid: "_packagesGrid_b7s07_122",
	packageRow: "_packageRow_b7s07_131",
	packageName: "_packageName_b7s07_151",
	npmIcon: "_npmIcon_b7s07_165",
	packageDownloads: "_packageDownloads_b7s07_170"
};
//#endregion
//#region pages/projects/components/ProjectCard.tsx
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: ProjectCard_module_default.projectInfo,
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						className: ProjectCard_module_default.sectionHeader,
						children: "Project Info"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: ProjectCard_module_default.infoRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: ProjectCard_module_default.infoLabel,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FaGithub, {}), "Source URL"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: ProjectCard_module_default.infoValue,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: p.url,
								target: "_blank",
								rel: "noreferrer",
								children: "type" in p && p.type === "github" ? p.data.full_name : p.repo
							})
						})]
					}),
					p.deployment && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: ProjectCard_module_default.infoRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: ProjectCard_module_default.infoLabel,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FaGlobe, {}), "Live URL"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: ProjectCard_module_default.infoValue,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeploymentLink, { deployment: p.deployment })
						})]
					}),
					p.documentationUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: ProjectCard_module_default.infoRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: ProjectCard_module_default.infoLabel,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FaBook, {}), "Documentation"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: ProjectCard_module_default.infoValue,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeploymentLink, { deployment: p.documentationUrl })
						})]
					}),
					p.stars ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: ProjectCard_module_default.infoRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: ProjectCard_module_default.infoLabel,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FaStar, {}), "Stars"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: ProjectCard_module_default.infoValue,
							children: p.stars
						})]
					}) : null,
					p.lastCommit && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: ProjectCard_module_default.infoRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: ProjectCard_module_default.infoLabel,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FaCalendar, {}), "Last Commit"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: ProjectCard_module_default.infoValue,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormattedDate, {
								date: p.lastCommit,
								format: "MMM do yyyy"
							})
						})]
			...
			p.languages && Object.keys(p.languages).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: ProjectCard_module_default.projectLanguages,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					className: ProjectCard_module_default.sectionHeader,
					children: "Languages Used"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: ProjectCard_module_default.languagesGrid,
					children: Object.entries(p.languages).sort(([, a], [, b]) => b - a).map(([name, percent]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: ProjectCard_module_default.languageRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: ProjectCard_module_default.languageName,
							children: [getLanguageLogo(name), name]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: ProjectCard_module_default.languageBar,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PercentBar, {
								percent,
			...
			p.publishedPackages && Object.keys(p.publishedPackages).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: ProjectCard_module_default.projectPackages,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					className: ProjectCard_module_default.sectionHeader,
					children: "Published Packages"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: ProjectCard_module_default.packagesGrid,
					children: Object.entries(p.publishedPackages).sort(([, a], [, b]) => b.downloads - a.downloads).map(([name, { url, downloads, registry }]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: ProjectCard_module_default.packageRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: ProjectCard_module_default.packageName,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								href: url,
								target: "_blank",
								rel: "noreferrer",
								children: [registry === "npm" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiNpm, { className: ProjectCard_module_default.npmIcon }), name]
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: ProjectCard_module_default.packageDownloads,
							children: [downloads.toLocaleString(), " weekly"]
						})]
					}, name))
				})]
			})
...
function DeploymentLink({ deployment }) {
	const [displayName, setDisplayName] = (0, import_react.useState)(deployment);
	(0, import_react.useEffect)(() => {
		try {
			setDisplayName((deployment.startsWith("/") ? new URL(deployment, window.location.origin) : deployment).toString());
		} catch {
...
//#endregion
//#region pages/projects/anchor.ts
/**
...
*/
function isContributorProject(project) {
...
function projectAnchorId(project) {
	return isContributorProject(project) ? project.data.full_name.replace("/", "-") : project.repo;
}
function projectTitle(project) {
	return isContributorProject(project) ? project.data.full_name : project.repo;
}
//#endregion
//#region pages/projects/+Page.tsx
var _Page_exports = /* @__PURE__ */ __exportAll({ Page: () => Page });
function Page() {
	const { projects } = useData();
	const [filterFn, setFilterFn] = (0, import_react.useState)(null);
	const [filteredProjects, setFilteredProjects] = (0, import_react.useState)(projects);
	const [sortFn, setSortFn] = (0, import_react.useState)(() => sortByRelevance);
	const [sortedProjects, setSortedProjects] = (0, import_react.useState)(() => {
		const fn = sortFn(projects);
		return [...filteredProjects].sort(fn);
	});
	(0, import_react.useEffect)(() => {
		setFilteredProjects(filterFn ? projects.filter((p) => filterFn(p)) : projects);
	}, [filterFn, projects]);
	(0, import_react.useEffect)(() => {
		if (filteredProjects) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Projects" }),
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							isContributor && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProjectCard, { project: p }),
					...
					idx < projects.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("hr", {})
				]
			}, anchor);
		})
	] });
...
//#endregion
//#region pages/projects/+Layout.tsx
...
//#endregion
//#region \0virtual:vike:page-entry:client:/pages/projects
var configValuesSerialized = {
	...
	["Page"]: {
		type: "standard",
		definedAtData: {
			"filePathToShowToUser": "/pages/projects/+Page.tsx",
			"fileExportPathToShowToUser": []
		},
		valueSerialized: {
			type: "plus-file",
	...
	["Layout"]: {
		type: "cumulative",
		definedAtData: [{
			"filePathToShowToUser": "/pages/projects/+Layout.tsx",
			"fileExportPathToShowToUser": []
		}, {
		...
		valueSerialized: [{
			...
			type: "plus-file",
			exportValues: _Layout_exports$1
		}]
	},
	["title"]: {
		type: "standard",
		definedAtData: {
			"filePathToShowToUser": "/pages/projects/+config.ts",
