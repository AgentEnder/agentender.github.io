...
var pageConfigsSerialized = [
	...
	},
	{
		...
		loadVirtualFilePageEntry: () => ({
			...
			moduleExportsPromise: __vitePreload(() => import("./pages_presentations_index.DORrx464.js"), __vite__mapDeps([15,1,16,11,3,4,5,17,10,12,13,7,18,19,20,21]))
		}),
		configValuesSerialized: {
			["hasServerOnlyHook"]: {
				type: "computed",
	...
	},
	{
		...
		loadVirtualFilePageEntry: () => ({
			...
			moduleExportsPromise: __vitePreload(() => import("./pages_projects.rg9_zS4S.js"), __vite__mapDeps([22,1,10,11,12,3,4,5,13,7,18,19,20,23,24]))
		}),
		configValuesSerialized: {
			["hasServerOnlyHook"]: {
				type: "computed",
	...
	},
	{
		...
		loadVirtualFilePageEntry: () => ({
			...
			moduleExportsPromise: __vitePreload(() => import("./pages_blog_view.-IxRLn1h.js"), __vite__mapDeps([33,1,10,11,12,3,4,5,13,7,18,19,30,31,20,34]))
		}),
		configValuesSerialized: {
			["hasServerOnlyHook"]: {
				type: "computed",
